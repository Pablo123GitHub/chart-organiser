...
class ChartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chart" do
    assert_difference('Chart.count') do
      post charts_url, params: { chart: { blindRange: @chart.blindRange, opponentType: @chart.opponentType, pokerSituation: @chart.pokerSituation } }
    end
  ...
  test "should update chart" do
    patch chart_url(@chart), params: { chart: { blindRange: @chart.blindRange, opponentType: @chart.opponentType, pokerSituation: @chart.pokerSituation } }
